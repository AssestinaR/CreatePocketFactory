...
public final class PocketFactoryPortalBlockItem extends BlockItem {
    ...
    public PocketFactoryPortalBlockItem(Block block, Properties properties) {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        MutableComponent line = factoryId.isPresent()
                ? Component.translatable("tooltip.create_pocket_factory.pocket_factory_portal.factory_id", factoryId.getAsInt())
                : Component.translatable("tooltip.create_pocket_factory.pocket_factory_portal.unbound");
