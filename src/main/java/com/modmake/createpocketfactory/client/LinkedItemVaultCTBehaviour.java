...
public class LinkedItemVaultCTBehaviour extends ConnectedTextureBehaviour.Base {
    @Override
    public CTSpriteShiftEntry getShift(BlockState state, Direction direction, @Nullable TextureAtlasSprite sprite) {
        Axis vaultBlockAxis = LinkedItemVaultBlock.getVaultAxis(state);
        boolean small = !LinkedItemVaultBlock.isLarge(state);
